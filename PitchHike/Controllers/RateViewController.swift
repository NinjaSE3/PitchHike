...
class RateViewController: UIViewController {
  ...
  func onClickRate1Star(sender: UIButton){
    print("onClickRate1Star")
    rate1Star.setTitleColor(accentColor, forState: .Normal)
    //AppDelegateのインスタンスを取得
    var appDelegate:AppDelegate = UIApplication.sharedApplication().delegate as! AppDelegate
    var userRes:JSON = self.getUser(JSON(self.getRequestStatus(appDelegate._requestStatusID!)["teacher"]).toString(true))
    var userRateRes = self.updateUserRate(JSON(userRes["userid"]).toString(true), rate: "1")
  }
  
  func onClickRate2Star(sender: UIButton){
    print("onClickRate2Star")
    rate1Star.setTitleColor(accentColor, forState: .Normal)
    rate2Star.setTitleColor(accentColor, forState: .Normal)
    //AppDelegateのインスタンスを取得
    var appDelegate:AppDelegate = UIApplication.sharedApplication().delegate as! AppDelegate
    var userRes:JSON = self.getUser(JSON(self.getRequestStatus(appDelegate._requestStatusID!)["teacher"]).toString(true))
    var userRateRes = self.updateUserRate(JSON(userRes["userid"]).toString(true), rate: "2")
  }
  
  func onClickRate3Star(sender: UIButton){
    print("onClickRate3Star")
    rate1Star.setTitleColor(accentColor, forState: .Normal)
    rate2Star.setTitleColor(accentColor, forState: .Normal)
    ...
    var appDelegate:AppDelegate = UIApplication.sharedApplication().delegate as! AppDelegate
    var userRes:JSON = self.getUser(JSON(self.getRequestStatus(appDelegate._requestStatusID!)["teacher"]).toString(true))
    var userRateRes = self.updateUserRate(JSON(userRes["userid"]).toString(true), rate: "3")
  }
  
  func onClickRate4Star(sender: UIButton){
    print("onClickRate4Star")
    rate1Star.setTitleColor(accentColor, forState: .Normal)
    rate2Star.setTitleColor(accentColor, forState: .Normal)
    rate3Star.setTitleColor(accentColor, forState: .Normal)
    ...
    var appDelegate:AppDelegate = UIApplication.sharedApplication().delegate as! AppDelegate
    var userRes:JSON = self.getUser(JSON(self.getRequestStatus(appDelegate._requestStatusID!)["teacher"]).toString(true))
    var userRateRes = self.updateUserRate(JSON(userRes["userid"]).toString(true), rate: "4")
  }
  
  func onClickRate5Star(sender: UIButton){
    print("onClickRate5Star")
    rate1Star.setTitleColor(accentColor, forState: .Normal)
    rate2Star.setTitleColor(accentColor, forState: .Normal)
    rate3Star.setTitleColor(accentColor, forState: .Normal)
    rate4Star.setTitleColor(accentColor, forState: .Normal)
    ...
    var appDelegate:AppDelegate = UIApplication.sharedApplication().delegate as! AppDelegate
    var userRes:JSON = self.getUser(JSON(self.getRequestStatus(appDelegate._requestStatusID!)["teacher"]).toString(true))
    var userRateRes = self.updateUserRate(JSON(userRes["userid"]).toString(true), rate: "5")
  }
